  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-16">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-3">
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          <div className="text-[11px] text-[#60716D] dark:text-slate-400 font-semibold flex items-center justify-between">
            <span>Total Peserta CKG</span>
            <Users className="w-3.5 h-3.5 text-[#00201C] dark:text-teal-400" />
          </div>
          <p className="text-xl font-bold text-[#102521] dark:text-white mt-1">{screenedCount.toLocaleString('id-ID')}</p>
          <p className="text-[10px] text-[#2E7D5B] dark:text-emerald-400 mt-0.5 font-medium">8 Kecamatan Kab. Pulau Taliabu</p>
        </div>
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          <div className="text-[11px] text-[#60716D] dark:text-slate-400 font-semibold flex items-center justify-between">
          ...
          <p className="text-xl font-bold text-[#102521] dark:text-white mt-1">{findingCount.toLocaleString('id-ID')}</p>
          <p className="text-[10px] text-amber-800 dark:text-amber-400 mt-0.5 font-medium">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          ...
          <p className="text-xl font-bold text-rose-700 dark:text-rose-400 mt-1">{highRiskCitizenCount.toLocaleString('id-ID')}</p>
          <p className="text-[10px] text-rose-800 dark:text-rose-400 mt-0.5 font-medium">Kategori Merah / Kritis</p>
        </div>
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          <div className="text-[11px] text-[#60716D] dark:text-slate-400 font-semibold flex items-center justify-between">
            <span>Tindak Lanjut (Level 2)</span>
            <CheckCircle2 className="w-3.5 h-3.5 text-sky-700 dark:text-sky-400" />
          </div>
          <p className="text-xl font-bold text-[#102521] dark:text-white mt-1">{impact.level2Continuity.percentage ?? 0}%</p>
          <p className="text-[10px] text-sky-800 dark:text-sky-400 mt-0.5 font-medium">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          <div className="text-[11px] text-[#60716D] dark:text-slate-400 font-semibold flex items-center justify-between">
            ...
            <Lock className="w-3.5 h-3.5 text-[#60716D]" />
          </div>
          <p className="text-sm font-bold text-[#102521] dark:text-white mt-1">Belum Dapat Dinilai</p>
          <p className="text-[10px] text-[#60716D] dark:text-slate-400 mt-0.5">Tata Kelola OI-08 Terkunci</p>
        </div>
        <div className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
          <div className="text-[11px] text-[#60716D] dark:text-slate-400 font-semibold flex items-center justify-between">
      ...
      {/* Filter Wilayah Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 sm:p-4 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6">
        ...
        <div
          id="where"
          className="p-4 sm:p-5 md:p-6 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs flex flex-col justify-between space-y-4 scroll-mt-4"
        >
      ...
      <div id="tindak-lanjut" className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 sm:gap-6 scroll-mt-4">
        ...
        <div className="p-4 sm:p-5 md:p-6 rounded-xl bg-white dark:bg-slate-900 border border-[#D8E5E2] dark:border-slate-800 shadow-2xs flex flex-col justify-between space-y-4">
          <div className="space-y-3">
            <div className="flex items-start justify-between gap-2 pb-3 border-b border-stone-200">
              <div className="flex items-center gap-2.5">
                <div className="p-2 rounded-xl bg-sky-100 text-sky-800 border border-sky-200">
